        ...
        <div class="project-image">
            ...
            <div class="project-overlay">
                <div class="project-links">
                    {#if project.liveUrl}
                        <a href={project.liveUrl} target="_blank" rel="noopener noreferrer" class="project-link" aria-label="View Live Project">
                    ...
                    {#if project.githubUrl}
                        <a href={project.githubUrl} target="_blank" rel="noopener noreferrer" class="project-link" aria-label="View Source Code">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <div class="project-content">
        <div class="project-header">
            ...
            <div class="project-meta">
                ...
                <span class="project-status" class:completed={project.status === 'completed'} 
                ...
                {#if project.company}
                    <div class="project-company">
                        {#if project.company.url}
                            <a href={project.company.url} target="_blank" rel="noopener noreferrer" class="company-link">
                                <svg class="company-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
