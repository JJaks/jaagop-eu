    ...
    export let experiences = [
        {
            ...
            description: "Leading development of scalable web applications and mentoring junior developers. Focus on architecture design and performance optimization.",
            tags: ["TypeScript", "React", "Node.js", "Kotlin","Swift", "React Native", "Inferno", "Team Leadership"]
        },
        {
            ...
            period: "2021 - 2022",
            location: "Estonia • Hybrid",
            description: "Developing Magento 2 web stores, custom modules, custom CMS pages, SEO, applying styling according to design guidelines.",
        ...
        },
        {
            ...
            description: "Fully custom front end development on Aurelia framework. Documenting, time management, team management and web development (Typescript, HTML5, CSS/SASS)",
        ...
        },
        {
            ...
            period: "2021 - 2021",
            location: "Estonia • Hybrid",
            description: "WordPress web development, fully custom themes, plugins and functions for real estate companies and online shops.",
