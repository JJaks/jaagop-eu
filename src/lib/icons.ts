...
export const icons = {
	// Arrow icons
	ArrowRight: ({ size = 24, class: className = '', 'stroke-width': strokeWidth = 2 }: IconProps = {}) => `
		<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${strokeWidth}" class="${className}" width="${size}" height="${size}">
			<path d="M5 12h14M12 5l7 7-7 7" />
		</svg>
	`,
	
	ArrowDown: ({ size = 24, class: className = '', 'stroke-width': strokeWidth = 2 }: IconProps = {}) => `
		<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${strokeWidth}" class="${className}" width="${size}" height="${size}">
	...
	// External link icon
	ExternalLink: ({ size = 24, class: className = '', 'stroke-width': strokeWidth = 2 }: IconProps = {}) => `
		<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${strokeWidth}" class="${className}" width="${size}" height="${size}">
	...
	// GitHub icon
	GitHub: ({ size = 24, class: className = '', 'stroke-width': strokeWidth = 2 }: IconProps = {}) => `
		<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${strokeWidth}" class="${className}" width="${size}" height="${size}">
	...
	// Contact icons
	Email: ({ size = 24, class: className = '', 'stroke-width': strokeWidth = 2 }: IconProps = {}) => `
		<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${strokeWidth}" class="${className}" width="${size}" height="${size}">
	...
	LinkedIn: ({ size = 24, class: className = '', 'stroke-width': strokeWidth = 2 }: IconProps = {}) => `
		<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${strokeWidth}" class="${className}" width="${size}" height="${size}">
	...
	Calendar: ({ size = 24, class: className = '', 'stroke-width': strokeWidth = 2 }: IconProps = {}) => `
		<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${strokeWidth}" class="${className}" width="${size}" height="${size}">
