...
export const projects: Project[] = [
    {
        title: "MactaBeauty",
        description: "Magento 2 E-commerce site of one of the biggest beauty related products selling company in Estonia. Magento 2 Frontend and custom modules & plugins.",
    ...
    },
    {
        ...
        description: "Customized Acty's Career page that feautres custom open job positions and forms. Made in Wordpress using Divi builder. Simple but very elegant.",
    ...
    {
        title: "Deleit",
        description: "Construction company website that features a portfolio, services, etc. Made in Wordpress using Elementor, a very simple page with full page cache.",
    ...
    },
    {
        ...
        description: "This was a Frontend Mentor challenge to create a URL Shortening API landing page. Semantic HTML, pure CSS & pure Javascript. Made with love.",
    ...
    {
        title: "Salome TK",
        description: "One of the first big projects I have made. An Extensive order center written in TypeScript using the Aurelia webpack, custom back and front-end.",
    ...
    {
        title: "TeliaTV",
        description: "The leading TV service in Estonia, I have worked on the frontend and backend of the web, mobile and TV applications. The web application is written in React, the mobile application is written in React Native and the TV application is written in Kotlin.",
        shortDescription: "Leading TV service in Estonia with web, mobile, and TV applications.",
        image: TeliaTVImage,
        technologies: ["React", "React Native", "Kotlin", "TypeScript", "Inferno", "Webpack", "Node.js", "Swift"],
    ...
    {
        title: "Zentria",
        description: "Custom site made using the NextJS framework, scss, Javascript. Implementing HTML5 UP design. Prototype.",
        shortDescription: "Custom site made using the NextJS framework, scss, Javascript. Implementing HTML5 UP design. Prototype.",
        image: ZentriaImage,
    ...
    {
        title: "KapitaliGrupp",
        description: "Real estate site that uses REST API to automatically get new listings from kv.ee, Wordpress, Elementor, custom functions made from scratch.",
        shortDescription: "Real estate site with automatic listings from kv.ee using REST API. Wordpress and Elementor.",
    ...
    {
        title: "Jausteenus",
        description: "Simple printing labels firm's site that was made using Wordpress, Elementor and shows off many custom functions made from scratch.",
    ...
    {
        title: "GoToAndPlay",
        description: "This was a homework type of assignment to apply for a job at gotoAndPlay. Made with Next.JS, TypeScript, HMTL5, CSS, tsparticles and magic.",
        shortDescription: "Homework assignment for gotoAndPlay job application using Next.JS, TypeScript, HTML5, CSS.",
